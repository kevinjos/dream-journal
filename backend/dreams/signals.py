...
def update_quality_frequencies_and_cleanup(
    ...
    **kwargs: dict[str, object]
    ...
    if action == "post_remove" and pk_set:
        ...
        orphaned_qualities = Quality.objects.filter(
            pk__in=pk_set,
            frequency=0
        )
...
def log_user_registration(sender: Type[User], request: HttpRequest, user: User, **kwargs: dict[str, object]) -> None:
    """
    ...
    user_agent = request.META.get('HTTP_USER_AGENT', 'unknown')[:100]  # Truncate long user agents
