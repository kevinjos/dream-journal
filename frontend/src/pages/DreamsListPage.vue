    ...
    <div class="dreams-list-container">
      ...
      <div v-else-if="dreams.length > 0" class="dreams-list">
        ...
        >
          <div class="text-body1 q-mb-sm">
            {{ dream.description?.substring(0, 200) }}{{ dream.description && dream.description.length > 200 ? '...' : '' }}
          </div>
      ...
      <q-card v-else flat bordered class="text-center q-pa-lg">
        ...
        <div class="text-body2 text-grey-5">
          {{ filterQuality ? 'Try a different quality or create more dreams' : 'Start capturing your dreams' }}
        </div>
      </q-card>
