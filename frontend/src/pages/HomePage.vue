  ...
  <q-page class="q-pa-md">
    <div class="home-container">
        ...
        <div v-else-if="dreams.length > 0">
          ...
          >
            <div class="text-body1">
              {{ dream.description?.substring(0, 100) }}{{ dream.description && dream.description.length > 100 ? '...' : '' }}
            </div>
      ...
      <div class="row q-gutter-md">
        <div class="col">
          <q-card flat bordered class="text-center q-pa-md cursor-pointer" @click="router.push('/dreams')">
            <div class="text-h4 text-primary">{{ stats.dreamCount }}</div>
            <div class="text-caption text-grey-6">Dreams</div>
          </q-card>
        </div>
        <div class="col">
          <q-card flat bordered class="text-center q-pa-md cursor-pointer" @click="router.push('/qualities')">
